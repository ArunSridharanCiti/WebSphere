...
module Liberty
  class BootstrapProperties
    ...
    def initialize(node, server_name)
      ...
      if !@utils.serverDirectoryExists?(server_name)
    ...
    def bootstrapPropertiesFile()
      return "#{@utils.serversDirectory}/#{@server_name}/bootstrap.properties"
    end
